...
/***/ function(module, exports, __webpack_require__) {
	...
	var ImageGrid_1 = __webpack_require__(99);
	var ImageView_1 = __webpack_require__(101);
	var AboutPage_1 = __webpack_require__(104);
	// store
	var store_1 = __webpack_require__(105);
	var router = (React.createElement(react_redux_1.Provider, { store: store_1.store },
	    React.createElement(react_router_1.Router, { history: store_1.history },
	        React.createElement(react_router_1.Route, { path: "/", component: App_1.App },
	            React.createElement(react_router_1.IndexRoute, { component: AboutPage_1.AboutPage }),
	            React.createElement(react_router_1.Route, { path: "/grid", component: ImageGrid_1.ImageGrid }),
	            React.createElement(react_router_1.Route, { path: "/view/:postId", component: ImageView_1.ImageView })))));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var creators = __webpack_require__(97);
	// My main component. We need to pass state to this component
	var Main_1 = __webpack_require__(98);
	...
	function mapDispatchToProps(dispatch) {
	    ...
	    var binding = redux_1.bindActionCreators(tmp, dispatch);
	    return binding;
	}
	// Wrapper factory
	// state -> props
	...
	var App = connectFunc(Main_1.Main);
	exports.App = App;
...
/***/ function(module, exports) {
	...
	function addComment(comment) {
	    return __assign({ type: "ADD_COMMENT" }, comment);
	}
	...
	var Main = (function (_super) {
	    ...
	    Main.prototype.render = function () {
	        return (React.createElement("div", null,
	            ...
	            React.createElement("span", null, "qweqwe"),
	            React.cloneElement(this.props.children, this.props)));
	    };
	    return Main;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Photo_1 = __webpack_require__(100);
	var ImageGrid = (function (_super) {
	    ...
	    ImageGrid.prototype.render = function () {
	        var _this = this;
	        return (React.createElement("div", null, this.props.posts.map(function (i) { return React.createElement(Photo_1.Photo, __assign({}, _this.props, { key: i.id, post: i })); })));
	    };
	    return ImageGrid;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Photo = (function (_super) {
	    ...
	    Photo.prototype.onLike = function (post) {
	    ...
	    Photo.prototype.render = function () {
	        ...
	        return (React.createElement("figure", null,
	            React.createElement(react_router_1.Link, { to: "/view/" + post.id },
	                React.createElement("h3", null, post.title),
	                React.createElement("img", { src: post.imgUrl, alt: post.title, width: "150", height: "150" })),
	            React.createElement("div", null,
	                React.createElement("button", { onClick: function () { return _this.onLike(post); } },
	                    " \u2665 ",
	                    post.likes,
	                    " ")),
	            React.createElement("figcaption", null,
	                React.createElement("p", null, " Some description of post "))));
	    };
	    return Photo;
	}(React.Component));
	exports.Photo = Photo;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Comment_1 = __webpack_require__(102);
	...
	var ImageView = (function (_super) {
	    ...
	    ImageView.prototype.onLike = function (post) {
	        this.props.inc(post.id);
	    };
	    ImageView.prototype.onRemoveComment = function (postId, commentId) {
	        this.props.removeComment(postId, commentId);
	    };
	    ImageView.prototype.onAddComment = function (postId, commentObj) {
	        var comment = __assign({}, commentObj, { postId: postId });
	        this.props.addComment(comment);
	    };
	    ImageView.prototype.render = function () {
	        var _this = this;
	        var postId = +(this.props.params.postId);
	        var post = this.props.posts.find(function (i) { return i.id === postId; });
	        var relatedComments = this.props.comments.filter(function (i) { return i.postId === postId; });
	        return (React.createElement("div", null,
	            ...
	            React.createElement("div", { className: "comments" },
	                relatedComments.map(function (c) { return React.createElement(Comment_1.Comment, { comment: c, onRemoveComment: function () { return _this.onRemoveComment(postId, c.id); } }); }),
	                React.createElement(CommentForm_1.CommentForm, { submit: function (commentObj) { return _this.onAddComment(postId, commentObj); } }))));
	    };
	    return ImageView;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Comment = (function (_super) {
	    ...
	    Comment.prototype.onRemoveComment = function (commentId) {
	        this.props.onRemoveComment(commentId);
	    };
	    Comment.prototype.render = function () {
	        var _this = this;
	        var comment = this.props.comment;
	        return (React.createElement("div", { className: "comment-clock" },
	            ...
	            React.createElement("span", null,
	                ...
	                comment.text,
	                " "),
	            React.createElement("button", { onClick: function () { return _this.onRemoveComment(comment.id); } }, "x")));
	    };
	    return Comment;
	}(React.Component));
	...
	var CommentForm = (function (_super) {
	    ...
	    CommentForm.prototype.render = function () {
	        ...
	        return (React.createElement("div", { className: "comment-form" },
	            React.createElement("input", { type: "text", placeholder: "author", ref: function (el) { return _this.authorEl = el; } }),
	            React.createElement("input", { type: "text", placeholder: "comment", ref: function (el) { return _this.commentEl = el; } }),
	            React.createElement("input", { type: "button", title: "Add comment", onClick: function () { return _this.onSubmit(); } })));
	    };
	    return CommentForm;
	}(React.Component));
	        ...
	        return (React.createElement("div", null,
	            ...
	            React.createElement("ul", null,
	                React.createElement("li", null,
	                    React.createElement(react_router_1.Link, { to: "/grid" }, " Grid ")),
	                React.createElement("li", null,
	                    React.createElement(react_router_1.Link, { to: "/view/qwe" }, " View qwe ")))));
	    };
	    return AboutPage;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var react_router_redux_1 = __webpack_require__(106);
	var react_router_1 = __webpack_require__(3);
	// Root reducer
	var reducers_1 = __webpack_require__(111);
	// data stub
	var posts_1 = __webpack_require__(114);
	var comments_1 = __webpack_require__(115);
	// default data
	var defaultState = {
	    posts: posts_1.default, comments: comments_1.default
	};
	exports.store = redux_1.createStore(reducers_1.default, defaultState);
	exports.history = react_router_redux_1.syncHistoryWithStore(react_router_1.browserHistory, exports.store);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _middleware = __webpack_require__(110);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var redux_1 = __webpack_require__(69);
	var react_router_redux_1 = __webpack_require__(106);
	var posts_1 = __webpack_require__(112);
	var comments_1 = __webpack_require__(113);
	// Creating composition of reducers
	//  each reducer binds for one property of state
	var rootReducer = redux_1.combineReducers({ posts: posts_1.default, comments: comments_1.default, routing: react_router_redux_1.routerReducer });
...
/***/ function(module, exports) {
	...
	function posts(state, action) {
	    ...
	    switch (action.type) {
	        case "INC_LIKES":
	            return state.map(function (i) { return i.id == action.postId ? __assign({}, i, { likes: i.likes + 1 }) : i; });
	    }
	    return state;
	}
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports) {
	...
	function comments(state, action) {
	    ...
	    switch (action.type) {
	        case "REMOVE_COMMENT":
	            return state.filter(function (c) { return c.id !== action.commentId; });
	        case "ADD_COMMENT":
	            var newId = Math.round(Math.random() * 1000);
	            var text = action.text, author = action.author, postId = action.postId;
	            var comment = {
	                id: newId,
	                text: text, author: author, postId: postId
	            };
	...
	var posts = [
	    {
	        id: 1,
	        title: "title 1",
	        imgUrl: "http://cs8.pikabu.ru/post_img/big/2016/12/24/7/1482574857142686562.png",
	        likes: 100
	    },
	    {
	        id: 2,
	        title: "title 2",
	        imgUrl: "https://wtf.jpg.wtf/700/41/4e/1482513407-414e8f1c5cb5f25402421d9d87f0166b.jpeg",
	        likes: 100
	    },
	    {
	        id: 3,
